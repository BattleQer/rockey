 ...
 *
 * Optimized by Allex Wang (allex.wxn@gmail.com)
 */
/*jslint regexp: true */
...
define(['module'], function (module) {
  ...
  text = {
      ...
      , finishLoad: function (name, strip, content, onLoad) {
          content = strip ? strstrip(content) : content;
      ...
      , load: function (name, req, onLoad, config) {
          ...
          if (!hasLocation || useXhr(url, defaultProtocol, defaultHostName, defaultPort)) {
              ...
              if (!req.specified(nonStripName))
                  throw new Error('Load cross module: ' + nonStripName + ' failed.');
              ...
              req([nonStripName], function (content) {
                  text.finishLoad(parsed.name + '.' + parsed.ext,
      ...
      , write: function (pluginName, moduleName, write, config) {
          if (buildMap.hasOwnProperty(moduleName)) {
              var content = escape(buildMap[moduleName]);
