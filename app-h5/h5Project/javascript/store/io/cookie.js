...
define(function(require, exports, module) {
    ...
    var trim = function(s) {
        ...
        var len = s.length, i = 0, j = len - 1, re = /(\u3000|\s|\t|\u00A0)/;
    ...
    var cookie = function(name, value, options) {
        ...
        if (value !== undefined) {
            ...
            var encode = function(s) { try { return options.raw ? s : encodeURIComponent(s) } catch (e) {} return s }
        ...
        // read
            ...
            var value = null
              ...
              , decode = function(s) { return options.raw ? s : decodeURIComponent(s) }
